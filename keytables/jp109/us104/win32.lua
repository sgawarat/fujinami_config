return {
  ...
  ALPHANUMERIC_KEYS = {
    Key.OEM_6, Key.DIGIT_1, Key.DIGIT_2, Key.DIGIT_3, Key.DIGIT_4, Key.DIGIT_5, Key.DIGIT_6, Key.DIGIT_7, Key.DIGIT_8, Key.DIGIT_9, Key.DIGIT_0, Key.OEM_MINUS, Key.OEM_7,
    Key.Q, Key.W, Key.E, Key.R, Key.T, Key.Y, Key.U, Key.I, Key.O, Key.P, Key.OEM_3, Key.OEM_4, Key.OEM_5,
    Key.A, Key.S, Key.D, Key.F, Key.G, Key.H, Key.J, Key.K, Key.L, Key.OEM_PLUS, Key.OEM_1,
