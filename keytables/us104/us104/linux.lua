return {
  ...
  ALPHANUMERIC_KEYS = {
    Key.GRAVE, Key.DIGIT_1, Key.DIGIT_2, Key.DIGIT_3, Key.DIGIT_4, Key.DIGIT_5, Key.DIGIT_6, Key.DIGIT_7, Key.DIGIT_8, Key.DIGIT_9, Key.DIGIT_0, Key.MINUS, Key.EQUAL,
    Key.Q, Key.W, Key.E, Key.R, Key.T, Key.Y, Key.U, Key.I, Key.O, Key.P, Key.LEFTBRACE, Key.RIGHTBRACE, Key.BACKSLASH,
  ...
  NON_ALPHANUMERIC_KEYS = {
    ...
    Key.BACKSPACE, Key.TAB, Key.ENTER, Key.CAPSLOCK, Key.SPACE, Key.COMPOSE,
