...
return layout.new {
  ...
  build = function (model, keytable, options)
    ...
    local aoi_alphanumeric_commands = model:map_to_keys {
      {"1"}, {"2"}, {"3"}, {"4"}, {"5"}, {},      {"6"},      {"7"}, {"8"}, {"9"}, {"0"}, {"["}, {"]"},
      {"p"}, {"d"}, {"r"}, {"g"}, {"f"}, {"@"}, {"y", "e"}, {"y", "u"}, {"y", "o"}, {"e"}, {"l"}, {"\""},
      {"n"}, {"s"}, {"t"}, {"k"}, {"h"}, {":"},      {"u"},      {"i"},      {"a"}, {"o"}, {"q"}, {"Backspace"},
      {"z"}, {"b"}, {"w"}, {"m"}, {"x"}, {";"}, {"y", "a"},      {"-"},      {","}, {"."}, {"/"},
    }
--    local aoi_alphanumeric_shift_commands = model:map_to_keys(shr.QWERTY_SHIFT_COMMANDS)
    ...
    elseif options.cao_type == "QWERTYSHR" then
      ...
      cao_alphanumeric_commands = aoi_alphanumeric_commands
      cao_alphanumeric_shift_commands = aoi_alphanumeric_shift_commands
    end
    ...
    return {
      ...
      simple_mappings {
        ...
        commands = aoi_alphanumeric_commands,
        shift_commands = aoi_alphanumeric_shift_commands,
